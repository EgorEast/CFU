...
### 1) Как создать консольное приложение С++?
  ...
  <figcaption> <i>Рис.1 Начальный экран MS VS </i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.2 Создание проекта</i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.3 Создание проекта<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.4 Изменить цветовую схему<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.5 Комментировать блок<i></figcaption>
  </figure>
 ...
 ### 4) Как открыть в проводнике Windows папку с проектом средствами VS?
  ...
  <figcaption><i>Рис.6 Диалоговое окно "Открыть файл"<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.7 Расширение файла-проекта<i></figcaption>
  </figure>
 ...
 **2 способ -** Через вкладку "Отладка". Во всплывшем списке выбираю "Запуск без отладки" (рис.8).
 ...
 <figure class="sign">
  ...
  <figcaption><i>Рис.8 Запуск без отладки<i></figcaption>
  </figure>
 ...
 **2 способ -** Через вкладку "Отладка". Во всплывшем списке выбираю "Начать отладку" (рис.9).
  ...
  <figcaption><i>Рис.9 Запуск в режиме отладки<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.10 Установка точки останова<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.11 Программа с кодом<i></figcaption>
  </figure>
  ...
  <figcaption><i>Рис.12 Brakepoint на 5 строке<i></figcaption>
  </figure>
  
  <figure class="sign">
  <img src= "./pic/13.png" width="400" alt="Brakepoint на 6 строке">
  <figcaption><i>Рис.13 Brakepoint на 6 строке<i></figcaption>
  </figure>
